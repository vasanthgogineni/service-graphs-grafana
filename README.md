...
Service graphs can be visualized in grafana using either Grafana Beyla or Cilium and Hubble. After considering both options, I decided to use Grafana Beyla. For a more detailed comparison and description of the process to set up Cilium and Hubble UI service graphs (and the possibility of visualizing the service graph in Grafana), refer to this [document](https://github.com/vasanthgogineni/service-graphs-grafana/blob/main/Beyla%20Service%20Graphs.pdf).
